...
%>
<div style="color: #cd8500; text-align: center; font-size: 30px;">My Cart <i class='fas fa-cart-arrow-down'></i></div>
<%
...
%>
          <tr>
            <th scope="col" style="background-color: #006e81;color:white;">Total: <i class="fa fa-inr"><%out.println(total); %></i> </th>
            <%if(total>0){ %><th scope="col"><a href="addressPayamentForOrder.jsp">Proceed to order</a></th><%} %>
          </tr>
        </thead>
        <thead>
          <tr>
